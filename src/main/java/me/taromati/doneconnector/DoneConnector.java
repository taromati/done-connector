...
public final class DoneConnector extends JavaPlugin implements Listener {
    ...
    private void loadConfig() throws DoneException {
        ...
        try {
            ...
            Set<String> nickname_list = this.getConfig().getConfigurationSection("치지직").getKeys(false);
            Logger.debug(nickname_list.toString());
        ...
        try {
            ...
            Set<String> nickname_list = this.getConfig().getConfigurationSection("숲").getKeys(false);
            nickname_list.addAll(this.getConfig().getConfigurationSection("아프리카").getKeys(false));
            Logger.debug(nickname_list.toString());
